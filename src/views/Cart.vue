<template>
	<div ref="container">
		<bread><a href="" slot="bread">Cart</a></bread>
					...
					<ul class="cart-item-list">
						<li v-for="item in cartList">
							...
							<div class="cart-tab-4">
								<div class="item-price-total">{{item.prodcutPrice*item.productNum}}</div>
							</div>
	...
	<div class="modal" v-if="mdShowCart" @click="closeModal">
		<p>你确认要删除这条数据吗？</p>
		<div class="btn-group">
			<button class="confirm-btn" @click="delCart">确认</button>
			<button class="close-btn" @click="mdShowCart = false">关闭</button>
		</div>
	</div>
	</transition>
	<div class="md-overlay" v-if="mdShowCart"></div>
</div>
</template>
<style lang="css">
	@import './../assets/css/checkout.css';
	.jinru-enter-active,.jinru-leave-active{
		transition:all 1s ease;
	}
	.jinru-enter,.jinru-leave-to{
